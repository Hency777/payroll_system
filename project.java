...
public class project extends JFrame implements ActionListener {
    ...
    project(){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("payroll/icon/payroll.jpg"));
        ...
        t1.setIcon(new ImageIcon(ClassLoader.getSystemResource("payroll/Icons/New.png")));
        ...
        t3.setMnemonic('S');
        t3.setIcon(new ImageIcon(ClassLoader.getSystemResource("payroll/icon/schedreport.png")));
        ...
        t4.setMnemonic('L');
        t4.setIcon(new ImageIcon(ClassLoader.getSystemResource("payroll/icon/newinvoice.png")));
        ...
        s1.setMnemonic('U');
        s1.setIcon(new ImageIcon(ClassLoader.getSystemResource("payroll/Icons/EditOpen.png")));
        ...
        s2.setMnemonic('p');
        s2.setIcon(new ImageIcon(ClassLoader.getSystemResource("payroll/icon/empreport.png")));
        ...
        s3.setMnemonic('T');
        s3.setIcon(new ImageIcon(ClassLoader.getSystemResource("payroll/icon/EXPENSE.PNG")));
        ...
        p1.setMnemonic('P');
        p1.setIcon(new ImageIcon(ClassLoader.getSystemResource("payroll/icon/payments.png")));
        ...
        p2.setMnemonic('L');
        p2.setIcon(new ImageIcon(ClassLoader.getSystemResource("payroll/icon/empreport.png")));
        ...
        u1.setIcon(new ImageIcon(ClassLoader.getSystemResource("payroll/Icons/New.png")));
        ...
        u2.setIcon(new ImageIcon(ClassLoader.getSystemResource("payroll/icon/calc.png")));
        ...
        u3.setIcon(new ImageIcon(ClassLoader.getSystemResource("payroll/icon/explorer.jpg")));
        ...
        m8i1.setMnemonic('X');
        m8i1.setIcon(new ImageIcon(ClassLoader.getSystemResource("payroll/icon/exit.PNG")));
